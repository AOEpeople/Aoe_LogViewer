...
abstract class Aoe_LogViewer_Model_AbstractCollection extends Varien_Data_Collection
{
    ...
    public function loadData($printQuery = false, $logQuery = false)
    {
        ...
        $xmlConfiguration = Mage::getConfig()->getNode($this->getXmlPath());
        /* @var $rulesConfiguration Mage_Core_Model_Config_Element */
        foreach ($xmlConfiguration->children() as $id => $node) {
