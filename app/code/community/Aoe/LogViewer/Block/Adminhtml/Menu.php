...
class Aoe_LogViewer_Block_Adminhtml_Menu extends Mage_Adminhtml_Block_Template
{
    ...
    {
        $data = array();
        $logCollection = Mage::getModel('aoe_logviewer/log_collection');
        /* @var $logCollection Aoe_LogViewer_Model_Log_Collection */
        foreach ($logCollection as $logId => $log) {
            ...
            foreach ($log->getCommandCollection() as $commandId => $command) {
